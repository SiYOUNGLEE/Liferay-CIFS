...
/**
 * DCE Data Packer Class <p>Contains static methods for packing/unpacking
 * different data types into a byte buffer.
 * 
 * @author gkspencer
 */
public class DCEDataPacker {
	 ...
	 * @return int
	 */
	public final static int putDCEString(
		byte[] buf, int off, String str, boolean incNul) {
