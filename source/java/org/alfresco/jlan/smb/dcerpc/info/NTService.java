...
public class NTService {
	...
	public static final int TypeDriver =
		TypeKernelDriver + TypeFileSystem + TypeAdapter + TypeRecognizer;
	...
	private static final String[] _srvState =
		{
	...
	private static final String[] _srvStart = {
		"Boot", "System", "Auto", "Demand", "Disabled"
	};

	// Service error control strings

	private static final String[] _srvError = {
		"Ignore", "Normal", "Severe", "Critical"
	};

	// Service controls accepted strings

	private static final String[] _srvCtrls = {
		"Stop", "PauseContinue", "Shutdown", "ParamChange", "NetBindChange"
	};
	...
	private static final String[] _srvType =
		{
			"KernelDriver", "FileSystem", "Adapter", "Recognizer",
			"OwnProcess", "ShareProcess"
		};
