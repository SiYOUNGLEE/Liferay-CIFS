...
/**
 * Unknown local domain exception. <p>The UnknownLocalDomainException is thrown
 * when the local domain name cannot be determined, this may be due to the local
 * node not actually running a Windows networking/SMB server.
 * 
 * @author gkspencer
 */
