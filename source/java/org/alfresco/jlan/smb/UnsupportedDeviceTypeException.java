...
/**
 * Unsupported device type exception class <p>The UnsupportedDeviceTypeException
 * is thrown when an attempt to connect to a remote device that is not supported
