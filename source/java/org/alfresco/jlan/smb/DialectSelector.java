...
/**
 * SMB dialect selector class. <p>Used to select the SMB/CIFS dialects that a
 * client can use when communicating with a remote server. The dialect list is
 * used by the client/server to agree the protocol level during the initial
 * SMB/CIFS negotiation phase.
 * 
 * @author gkspencer
 */
