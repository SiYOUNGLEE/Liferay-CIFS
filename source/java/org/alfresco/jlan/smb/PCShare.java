...
/**
 * PC share class. <p>The PC share class holds the details of a network share,
 * including the required username and password access control.
 * 
 * @author gkspencer
 */
public final class PCShare {

	// Flag to control whether the user name is parsed into domain and user name
	// values when
