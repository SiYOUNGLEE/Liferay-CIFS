...
/**
 * SMB status code class. <p> The SMBStatus class contains the error class and
 * error code values that a remote server may return. <p> The available error
 * classes are defined below :- <p> <table border="1" cellpadding="0"
 * cellspacing="0" width="80%"> <tr> <td width="25%"
 * bgcolor="#F4F5C7">SMBStatus.Succes</td> <td width="75%">Indicates that an SMB
 * request was successful</td> </tr> <tr> <td width="25%"
 * bgcolor="#F4F5C7">SMBStatus.ErrDOS</td> <td width="75%">Error is from the DOS
 * operating system set</td> </tr> <tr> <td width="25%"
 * bgcolor="#F4F5C7">SMBStatus.ErrSrv</td> <td width="75%">Error is from the
 * server network file manager</td> </tr> <tr> <td width="25%"
 * bgcolor="#F4F5C7">SMBStatus.ErrHrd</td> <td width="75%">Error is a hardware
 * type error</td> </tr> <tr> <td width="25%"
 * bgcolor="#F4F5C7">SMBStatus.ErrCmd</td> <td width="75%">Command was not in
 * the SMB format</td> </tr> <tr> <td width="25%"
 * bgcolor="#F4F5C7">SMBStatus.NetErr</td> <td width="75%">Errors returned by
 * SMB transactions</td> </tr> <tr> <td width="25%"
 * bgcolor="#F4F5C7">SMBStatus.NTErr</td> <td width="75%">32 bit errors returned
 * when NT dialect is in use</td> </tr> <tr> <td width="25%"
 * bgcolor="#F4F5C7">SMBStatus.DCERPCErr</td> <td width="75%">Errors returned by
 * DCE/RPC requests</td> </tr> <tr> <td width="25%"
 * bgcolor="#F4F5C7">SMBStatus.JLANErr</td> <td width="75%">JLAN error
 * codes</td> </tr> </table>
 * 
 * @author gkspencer
 */
