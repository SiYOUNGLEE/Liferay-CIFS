...
/**
 * SMB dialect class. <p>This class contains the available SMB protocol dialects
 * that may be negotiated when an SMB session is setup.
 * 
 * @author gkspencer
 */
public final class Dialect {
	...
	private static final String[] protList =
		{
			...
			"MICROSOFT NETWORKS 3.0", "DOS LANMAN1.0", "LANMAN1.0",
			"DOS LM1.2X002", "LM1.2X002", "DOS LANMAN2.1", "LANMAN2.1",
			"Samba", "NT LM 0.12", "NT LANMAN 1.0"
		};
	...
	private static final String[] protType =
		{
			"Core", "CorePlus", "DOS LANMAN 1.0", "LANMAN1.0",
			"DOS LANMAN 2.1", "LM1.2X002", "LANMAN2.1", "NT LM 0.12"
		};
	...
	private static final int[] protIdx =
		{
			Core, CorePlus, DOSLanMan1, DOSLanMan1, LanMan1, DOSLanMan2,
			LanMan2, LanMan2_1, LanMan2_1, NT, NT, NT
		};
