...
class DiskInfoPacker {
	 ...
	 */
	public final static void packVolumeInfo(
		VolumeInfo info, DataBuffer buf, boolean uni) {
	 ...
	 * @param buf Buffer to pack data into.
	 */
	public final static void packFsSizeInformation(
		SrvDiskInfo info, DataBuffer buf) {
	 ...
	 * @param uni Use Unicode strings if true, else use ASCII strings
	 */
	public final static void packFsVolumeInformation(
		VolumeInfo info, DataBuffer buf, boolean uni) {
	 ...
	 * @param buf Buffer to pack data into.
	 */
	public final static void packFsDevice(
		int typ, int devChar, DataBuffer buf) {
	 ...
	 * @param buf Buffer to pack data into.
	 */
	public final static void packFsAttribute(
		int attr, int maxName, String fsType, boolean uni, DataBuffer buf) {
	 ...
	 * @param buf Buffer to pack the data into.
	 */
	public final static void packMacFsInformation(
		DiskInfo diskInfo, VolumeInfo volInfo, boolean ntfs, DataBuffer buf) {
		...
		buf.putInt(diskInfo.getBlockSize() *
		...
		DataPacker.putIntelInt(
			ntfs ? 0 : MacNoStreamsOrMacSupport, buf.getBuffer(),
			buf.getPosition());
	 ...
	 * @param buf Buffer to pack data into.
	 */
	public final static void packFullFsSizeInformation(
		long userLimit, SrvDiskInfo info, DataBuffer buf) {
