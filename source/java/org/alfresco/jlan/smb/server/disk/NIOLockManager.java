...
/**
 * NIO Lock Manager Class <p>File lock manager implementation that uses the Java
 * NIO file locking capabilities.
 * 
 * @author gkspencer
 */
public class NIOLockManager implements LockManager {
	...
	public void lockFile(
		...
		// Add the lock to the file instance so that locks can be removed if the
		// file is
