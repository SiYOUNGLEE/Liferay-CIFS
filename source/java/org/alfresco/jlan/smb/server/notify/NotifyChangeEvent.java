...
/**
 * Notify Change Event Class <p>Contains the details of a change notification
 * event
 * 
 * @author gkspencer
 */
public class NotifyChangeEvent {
	...
	public NotifyChangeEvent(
		int filter, int action, String fname, boolean dir) {
	 ...
	 */
	public NotifyChangeEvent(
		int filter, int action, String fname, String oldname, boolean dir) {
