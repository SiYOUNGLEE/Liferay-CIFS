...
/**
 * Find Information Packer Class <p>Pack file information for a find first/find
 * next information level.
 * 
 * @author gkspencer
 */
class FindInfoPacker {
	 ...
	 */
	public final static int packInfo(
		FileInfo info, DataBuffer buf, int infoLevel, boolean uni)
	 ...
	 * @param uni true if Unicode strings are being used, or false for ASCII
	 *            strings
	 * @return int Buffer space required, or -1 if unknown information level.
	 */
	public final static int calcInfoSize(
		FileInfo info, int infoLev, boolean resKey, boolean uni) {
	 ...
	 * @param offset int
	 */
	public static final void clearNextOffset(
		DataBuffer buf, int level, int offset) {
	 ...
	 * @param uni Pack Unicode strings if true, else pack ASCII strings
	 */
	protected final static void packInfoStandard(
	 ...
	 * @param uni Pack Unicode strings if true, else pack ASCII strings
	 */
	protected final static void packInfoFileName(
		FileInfo info, DataBuffer buf, boolean uni) {
	 ...
	 * @param uni Pack Unicode strings if true, else pack ASCII strings
	 */
	protected final static void packInfoDirectory(
		FileInfo info, DataBuffer buf, boolean uni) {
	 ...
	 * @param uni Pack Unicode strings if true, else pack ASCII strings
	 */
	protected final static void packInfoDirectoryFull(
		FileInfo info, DataBuffer buf, boolean uni) {
	 ...
	 * @param uni Pack Unicode strings if true, else pack ASCII strings
	 */
	protected final static void packInfoDirectoryBoth(
		FileInfo info, DataBuffer buf, boolean uni) {
	 ...
	 * @param uni Pack Unicode strings if true, else pack ASCII strings
	 */
	protected final static void packInfoDirectoryBothId(
		FileInfo info, DataBuffer buf, boolean uni) {
	 ...
	 * @param uni Pack Unicode strings if true, else pack ASCII strings
	 */
	protected final static void packInfoMacHfs(
		FileInfo info, DataBuffer buf, boolean uni) {
	 ...
	 * @param uni boolean
	 */
	private static final void pack8Dot3Name(
		DataBuffer buf, String fileName, boolean uni) {
	 ...
	 */
	protected final static void packInfoFullDirectoryId(
