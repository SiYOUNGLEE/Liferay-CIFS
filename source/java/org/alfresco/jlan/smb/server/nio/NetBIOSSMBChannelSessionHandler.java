...
/**
 * NetBIOS SMB Channel Session Handler Class <p>Handle CIFS socket connections
 * via NetBIOS, usually port 139.
 * 
 * @author gkspencer
 */
public class NetBIOSSMBChannelSessionHandler extends ChannelSessionHandler {
	 ...
	 * @param port int
	 */
	public NetBIOSSMBChannelSessionHandler(
	...
	public PacketHandler createPacketHandler(SocketChannel sockChannel)
		...
		return new NetBIOSSMBChannelHandler(
