...
/**
 * Asynchronous Winsock NIO CIFS Read Request Class <p>Holds the details of a
...
public class AsyncWinsockCIFSReadRequest implements ThreadRequest {
	 ...
	 */
	public AsyncWinsockCIFSReadRequest(
	...
	public void runRequest() {
		...
		if (m_sess.isShutdown() == false) {
			...
			try {
				...
				// Debug.println("[SMB] Read packet, sess=" +
				// m_sess.getUniqueId() + " ,pkt=" + smbPkt);
