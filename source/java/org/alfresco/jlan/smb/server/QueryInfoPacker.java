...
/**
 * Query File Information Packer Class <p>Packs file/directory information for
...
public class QueryInfoPacker {
	 ...
	 */
	private static void packInfoStandard(
	 ...
	 * @param uni Pack unicode strings
	 */
	private static void packNameFileInfo(
	 ...
	 * @param uni Pack unicode strings
	 */
	private static void packAllFileInfo(
		FileInfo info, DataBuffer buf, boolean uni) {
	 ...
	 * @param uni Pack unicode strings
	 */
	private static void packStreamFileInfo(
		FileInfo info, DataBuffer buf, boolean uni) {
	 ...
	 * @return int
	 */
	public static int packStreamFileInfo(
		StreamInfoList streams, DataBuffer buf, boolean uni) {
