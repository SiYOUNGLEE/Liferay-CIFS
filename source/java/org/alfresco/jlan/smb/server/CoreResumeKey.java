...
class CoreResumeKey {
	...
	/**
	 * Return the server area resume key value. This is the search context index
	 * in our case.
	 * 
	...
	public final static void putResumeKey(
		byte[] buf, int pos, String fileName, int ctxId) {
	 ...
	 * @param conArea byte[]
	 */
	public static final void setConsumerArea(
		byte[] buf, int pos, byte[] conArea) {
	...
	/**
	 * Set the resume key server area value. This is the search context index in
	 * our case.
	 * 
	 * @param srvVal int
	 */
