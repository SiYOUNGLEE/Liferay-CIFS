...
/**
 * File Stream Information Class <p>Contains the details of a file stream.
 * 
 * @author gkspencer
 */
public class StreamInfo {
	...
	/**
	 * Set the path, if it contains the stream name the path will be split into
	 * file name and stream name components.
	 * 
	 * @param path String
	 */
	...
	/**
	 * Set the set stream information flags to indicated which values are to be
	 * set
	 * 
	 * @param setFlags int
	 */
