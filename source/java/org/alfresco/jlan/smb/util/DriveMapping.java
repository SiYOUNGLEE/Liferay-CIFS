...
/**
 * Network Drive Mapping Class <p>Contains the details of a network drive
 * mapping that may be created using the Win32Utils MapNetworkDrive method.
 * 
 * @author gkspencer
 */
public class DriveMapping {
	...
	//
	// If the username or password is null the default value is used (ie. the
	// logged in users credentials)

	private String m_userName;
	private String m_password;

	// Flags to control if the user is prompted for a username/password if the
	// supplied
	// values do not work or to always prompt the user.

	private boolean m_interactive; // Prompt the user if the username/password
									// fail
	 ...
	 */
	public DriveMapping(
		String localDrive, String remotePath, String userName, String password,
