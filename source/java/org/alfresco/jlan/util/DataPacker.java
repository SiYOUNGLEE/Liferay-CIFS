...
public final class DataPacker {
	 ...
	 *         found.
	 */
	public final static String getDataString(
		char typ, byte[] bytarray, int pos, int maxlen, boolean uni) {
	 ...
	 * @exception java.lang.IndexOutOfBoiundsException If there is not enough
	 *                data in the buffer.
	 */
	public final static int getIntelShort(byte[] bytarray, int pos)
		...
		int sVal =
			(((int) bytarray[pos + 1] << 8) + ((int) bytarray[pos] & 0xFF));
	...
	public final static int getShort(byte[] bytarray, int pos)
		...
		if (bigEndian == true) {
			...
			sVal = ((((int) bytarray[pos + 1]) << 8) + 
				((int) bytarray[pos] & 0xFF));
		}
		else {

			// Little endian

			sVal = ((((int) bytarray[pos]) << 8) + 
				((int) bytarray[pos + 1] & 0xFF));
		}
	...
	public final static String getString(
		byte[] bytarray, int pos, int maxlen, boolean isUni) {
	...
	public final static String getUnicodeString(byte[] byt, int pos, int maxlen) {
		...
		do {
			...
			curChar = (char) (((byt[endpos + 1] & 0xFF) << 8) + 
				(byt[endpos] & 0xFF));
	 ...
	 * @exception java.lang.IndexOutOfBoundsException If the buffer does not
	 *                have enough space.
	 */
	 ...
	 */
	public final static int putString(
		String str, byte[] bytarray, int pos, boolean nullterm) {
	 ...
	 */
	public final static int putString(
		String str, int fldLen, byte[] bytarray, int pos) {
	 ...
	 * @param pos Position to start packing the string
	 * @param nullterm true if the string should be null terminated, else false
	 * @param isUni true if the string should be packed as Unicode, false to
	 *            pack as ASCII
	 * @return The ending buffer position
	 */
	public final static int putString(
		String str, byte[] bytarray, int pos, boolean nullterm, boolean isUni) {
	 ...
	 * @return The ending buffer position
	 */
	public final static int putUnicodeString(
		String str, byte[] bytarray, int pos, boolean nullterm) {
	 ...
	 * @exception java.lang.ArrayIndexOutOfBoundsException If the buffer does
	 ...
	 * @return int
	 */
	public final static int getBufferPosition(
		int pos, String str, boolean uni, boolean nul) {
