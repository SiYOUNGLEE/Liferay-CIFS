...
public class Rpc {
	...
	public static final int StsProcUnavail = 3; // program does not support
												// procedure
	public static final int StsBadArgs = 4; // bad arguments in request

	// Call rejected status codes

	public static final int StsRpcMismatch = 0; // RPC version number does not
												// equal 2
	...
	public static final int AuthRejectedVerf = 4; // verifier rejected or
													// replayed
