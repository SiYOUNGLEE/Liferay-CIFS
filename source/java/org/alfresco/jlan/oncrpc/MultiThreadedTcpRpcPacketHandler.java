...
/**
 * Multi-Threaded Tcp Rpc Packet Handler Class <p>Adds multi-threaded processing
 * of RPC requests to the standard TCP RPC handler.
 * 
 * @author gkspencer
 */
public class MultiThreadedTcpRpcPacketHandler extends TcpRpcPacketHandler
	 ...
	 * @throws IOException
	 */
	public MultiThreadedTcpRpcPacketHandler(
	...
	protected void processRpc(RpcPacket rpc)
		...
		// Queue the RPC request to the session handlers thread pool for
		// processing
