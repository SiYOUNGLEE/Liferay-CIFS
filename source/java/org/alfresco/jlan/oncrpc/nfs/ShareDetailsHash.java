...
/**
 * Share Details Hash Class <p>Hashtable of ShareDetails for the available disk
 * shared devices. ShareDetails are indexed using the hash of the share name to
 * allow mounts to be persistent across server restarts.
 * 
 * @author gkspencer
 */
