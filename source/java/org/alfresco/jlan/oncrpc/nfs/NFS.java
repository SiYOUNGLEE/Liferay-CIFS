...
public final class NFS {
	...
	public static final int FileSysHomogeneuos = 0x0004; // PATHCONF valid for
															// all files
	public static final int FileSysCanSetTime = 0x0008; // can set time on
														// server side
	...
	private static final String[] _procNames =
		{
			"Null", "GetAttr", "SetAttr", "Lookup", "Access", "ReadLink",
			"Read", "Write", "Create", "MkDir", "SymLink", "MkNode", "Remove",
