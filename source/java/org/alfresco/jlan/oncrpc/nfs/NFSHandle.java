...
/**
 * NFS Handle Class <p>Contains constants and static methods used with NFS
 * handles in the JLAN Server.
 * 
 * @author gkspencer
 */
public class NFSHandle {
	 ...
	 * @param hlen int
	 */
	public static final void packShareHandle(
		String name, RpcPacket rpc, int hlen) {
	 ...
	 * @param handle byte[]
	 */
	public static final void packDirectoryHandle(
		int shareId, int dirId, byte[] handle) {
	 ...
	 */
	public static final void packDirectoryHandle(
		int shareId, int dirId, RpcPacket rpc, int hlen) {
	 ...
	 * @param handle byte[]
	 */
	public static final void packFileHandle(
		int shareId, int dirId, int fileId, byte[] handle) {
	 ...
	 */
	public static final void packFileHandle(
		int shareId, int dirId, int fileId, RpcPacket rpc, int hlen) {
	...
	public static final int unpackShareId(byte[] handle) {
		...
		if (handle[1] == TYPE_SHARE || handle[1] == TYPE_DIR ||
			handle[1] == TYPE_FILE) {
