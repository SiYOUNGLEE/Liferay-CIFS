...
/**
 * MD5 Checksum File Processor Class <p>Calculate an MD5 checksum for a file
 * before it is stored and save the result in a database field.
 * 
 * @author gkspencer
 */
public class Md5SumFileProcessor implements FileProcessor {
	...
	public void processStoredFile(
		...
		Debug.println(
			"## StoreFile file=" + state.getPath() + ", fid=" +
			state.getFileId() + ", temp=" + segment.getTemporaryFile() +
			", MD5=" + md5sum);
	}
