...
/**
 * <p>The class extends the client side version of the disk information class to
 * allow values to be set after construction by a disk interface implementation.
 * <p>The class contains information about the total, free and used blocks on a
 * disk device, and the block size and blocks per allocation unit of the device.
 * 
 * @author gkspencer
 */
public class SrvDiskInfo extends DiskInfo {
	 ...
	 */
	public SrvDiskInfo(
		long totunits, long blkunit, long blksiz, long freeunit) {
	...
	protected SrvDiskInfo(
		PCShare shr, int totunits, int blkunit, int blksiz, int freeunit) {
