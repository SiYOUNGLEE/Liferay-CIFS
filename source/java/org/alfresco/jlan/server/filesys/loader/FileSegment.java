...
/**
 * File Segment Class <p>Contains the details of a segment of file data.
 * 
 * @author gkspencer
 */
public class FileSegment {
	...
	/**
	 * Class constructor <p>Create a file segment to hold all data for a file.
	 * 
	...
	/**
	 * Get the load lock for this file. If successful the current thread will
	 * proceed and can load the file, else the thread will wait until the load
	 * has been completed by the thread with the lock.
	 * 
	 * @return boolean true if the current thread has the load lock, else false
	 *         to indicate that the file should now be loaded.
	 ...
	 * @exception IOException
	 */
	public synchronized final int readBytes(
		byte[] buf, int len, int pos, long fileOff)
		throws IOException {
	 ...
	 * @exception IOException
	 */
	public synchronized final void writeBytes(
		byte[] buf, int len, int pos, long fileOff)
		throws IOException {
	 ...
	 * @exception IOException
	 */
	public final static FileSegment createSegment(
		FileSegmentInfo info, String prefix, String fname, File tempDir,
		boolean writeable)
		throws IOException {
	 ...
	 */
	public final static FileSegment createSegment(
		FileSegmentInfo info, String fname, File tempDir, boolean writeable)
		throws IOException {
	...
	private final void checkFileDescriptor()
		...
		if (m_segment != null) {
			...
			if (m_segment.getFD() != null && 
							m_segment.getFD().valid() == false) {
