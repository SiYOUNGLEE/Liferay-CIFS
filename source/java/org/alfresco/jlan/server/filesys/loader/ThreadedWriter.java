...
/**
 * Threaded Writer Class <p>Allows a network protocol handler to queue a write
 * request to a thread pool for delayed writing.
 * 
 * @author gkspencer
 */
public class ThreadedWriter {
	...
	protected class ThreadWorker implements Runnable {
		...
		public void run() {
			...
			if (Debug.EnableInfo && hasDebug())
				Debug.println("ThreadedWriter thread=" + mi_thread.getName() +
					" shutdown");
		}
	};
