...
/**
 * Delete File Request Class <p>Contains the details of a file that has been
 * marked for delete when the database is offline.
 * 
 * @author gkspencer
 */
public class DeleteFileRequest extends FileRequest {
	...
	public DeleteFileRequest(
		int fid, int stid, String tempPath, String virtPath, FileState state) {
