...
/**
 * Single File Request Class <p>Contains the details of a single file load or
 * save request.
 * 
 * @author gkspencer
 */
public class SingleFileRequest extends FileRequest {
	...
	public SingleFileRequest(
		int typ, int fid, int stid, String tempPath, String virtPath,
		FileState state) {
		super(typ);
		m_fid = fid;
		m_stid = stid;
	 ...
	 */
	public SingleFileRequest(
		int typ, int fid, int stid, FileSegmentInfo segInfo, String virtPath,
		FileState state) {
		super(typ);
		m_fid = fid;
		m_stid = stid;
	 ...
	 */
	public SingleFileRequest(
		int typ, int fid, int stid, String tempPath, String virtPath, int seq,
		FileState state) {
