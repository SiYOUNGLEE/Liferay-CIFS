...
/**
 * File Loader Interface <p>A file loader is responsible for loading, storing
 * and deleting the data associated with a file in a virtual filesystem. A file
 * is identified using a unique file id.
 * 
 * @author gkspencer
 */
