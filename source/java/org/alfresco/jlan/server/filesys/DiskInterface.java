...
/**
 * The disk interface is implemented by classes that provide an interface for a
 * disk type shared device.
 * 
 * @author gkspencer
 */
public interface DiskInterface extends DeviceInterface {
	...
	/**
	 * Check if the specified file exists, and whether it is a file or
	 * directory.
	 * 
	 * @param sess Server session
	 * @param tree Tree connection
	...
	/**
	 * Start a new search on the filesystem using the specified searchPath that
	 ...
	 * @param attrib Attributes of the file(s) to search for, see class
	 *            SMBFileAttribute.
	 * @exception java.io.FileNotFoundException If the search could not be
	 *                started.
	 */
