...
/**
 * <p>The share listener interface provides a hook into the server so that an
 * application is notified when a session connects/disconnects from a particular
 * share.
 * 
 * @author gkspencer
 */
