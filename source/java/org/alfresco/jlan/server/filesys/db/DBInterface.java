...
/**
 * Database Interface <p>Used by the DBDiskDriver virtual filesystem to provide
 * the interface to the database allowing different databases to be used to
 * store the file system strucuture, NTFS streams, file data and retention
 * information.
 * 
 * @author gkspencer
 */
public interface DBInterface {
	...
	public static final int FeatureQueue = 0x0004; // background load/save
													// queues
	public static final int FeatureData = 0x0008; // load/save file data to
													// database fields
	public static final int FeatureJarData = 0x0010; // load/save multiple file
														// data to Jar files
	public static final int FeatureObjectId = 0x0020; // keep file id to object
														// id mapping details
	...
	// File stream information levels, for getStreamInformation() and
	// getStreamsList() methods
	...
	public void initializeDatabase(
		DBDeviceContext context, ConfigElement params)
