...
/**
 * Directory Network File Class <p>The directory network file is used by file
 * loader implementations that only store file data and do not store the
...
public class DirectoryNetworkFile extends DBNetworkFile {
	 ...
	 */
	public DirectoryNetworkFile(
		String name, int fid, int did, FileState state) {
		super(name, fid, 0, did);
		setFileState(state);
	}
