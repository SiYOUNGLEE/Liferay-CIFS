...
/**
 * Database Data Details Class <p>Contains the details of the data records that
 * hold the data for a file or stream.
 * 
 * @author gkspencer
 */
public class DBDataDetails {
	 ...
	 */
	public DBDataDetails(
		int fileId, int streamId, int jarId, int numFragments, 
		int sizeFragment) {
