...
/**
 * <p>A disk shared device has a name, a driver class and a context for the
 * driver.
 * 
 * @author gkspencer
 */
public class DiskSharedDevice extends SharedDevice {
	 ...
	 */
	public DiskSharedDevice(
		String name, DeviceInterface iface, DiskDeviceContext ctx) {
	 ...
	 */
	public DiskSharedDevice(
		String name, DeviceInterface iface, DiskDeviceContext ctx, int attrib) {
