...
/**
 * SMB file access mode class. <p>The SMB access mode values are used when
 * opening a file using one of the SMBDiskSession OpenFile (), OpenInputStream
 * () or OpenOutputStream () methods.
 * 
 * @author gkspencer
 */
public final class AccessMode {
	...
	public static final int NTFileWriteCheck =
		NTWrite + NTAppend + NTWriteEA + NTWriteAttrib + NTWriteDAC +
			NTWriteOwner;
	public static final int NTFileReadCheck =
		NTRead + NTReadEA + NTReadAttrib + NTReadControl;
