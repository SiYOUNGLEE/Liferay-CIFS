...
/**
 * Security Descriptor Interface <p>Optional interface that a DiskInterface
 * driver can implement loading and saving of per file security descriptors.
 * 
 * @author gkspencer
 */
public interface SecurityDescriptorInterface {
	...
	public int getSecurityDescriptorLength(
		SrvSession sess, TreeConnection tree, NetworkFile netFile)
	 ...
	 * @exception SMBSrvException
	 */
	public SecurityDescriptor loadSecurityDescriptor(
		SrvSession sess, TreeConnection tree, NetworkFile netFile)
		throws SMBSrvException;
	 ...
	 * @exception SMBSrvException
	 */
	public void saveSecurityDescriptor(
		SrvSession sess, TreeConnection tree, NetworkFile netFile,
