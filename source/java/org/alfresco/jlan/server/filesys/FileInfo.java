...
/**
 * File information class. <p>The FileInfo class is returned by the
...
public class FileInfo {
	...
	// and should be used to set
	// the file information.

	private int m_setFlags;

	// Network file object, used when a set information call uses the file
	// id/handle
	...
	public FileInfo(String fname, long fsize, int fattr) {
		if (fname == null) {
			throw new UnsupportedOperationException("FUCK! A NULL FILENAME");
		}
		m_name = fname;
		m_size = fsize;
		m_attr = fattr;
	 ...
	 */
	public FileInfo(
		String fpath, String fname, long fsize, int fattr, int ftime) {
	 ...
	 */
	public FileInfo(
		String fpath, String fname, long fsize, int fattr, int fdate, 
		int ftime) {
