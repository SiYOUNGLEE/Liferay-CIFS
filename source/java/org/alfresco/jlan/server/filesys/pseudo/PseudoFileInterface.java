...
/**
 * Pseudo File Interface <p> Provides the ability to add files into the file
 * listing of a folder.
 * 
 * @author gkspencer
 */
public interface PseudoFileInterface {
	...
	/**
	 * Return the pseudo file for the specified path, or null if the path is not
	 * a pseudo file
	 * 
	 * @param sess SrvSession
	 * @param tree TreeConnection
	 ...
	 * @return int
	 */
	public int addPseudoFilesToFolder(
		SrvSession sess, TreeConnection tree, String path);
