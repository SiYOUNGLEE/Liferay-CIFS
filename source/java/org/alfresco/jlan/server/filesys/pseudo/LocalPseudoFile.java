...
/**
 * Local Pseudo File Class <p> Pseudo file class that uses a file on the local
 * filesystem.
 * 
 * @author gkspencer
 */
		...
		if (getInfo() == null) {
			...
			if (localFile.exists()) {
				...
				FileInfo fInfo = new FileInfo(
					getFileName(), localFile.length(), getAttributes());
				...
				fInfo.setAllocationSize(
					(localFile.length() + 512L) & 0xFFFFFFFFFFFFFE00L);
