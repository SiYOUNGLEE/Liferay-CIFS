...
/**
 * File Open Parameters Class <p>Contains the details of a file open request.
 * 
 * @author gkspencer
 */
public class FileOpenParams {
	...
	private static String[] _openMode = {
	 ...
	 * @param pid int
	 */
	public FileOpenParams(
		String path, int openAction, int accessMode, int fileAttr, int pid) {
	 ...
	 */
	public FileOpenParams(
		String path, int openAction, int accessMode, int fileAttr, int gid,
		int uid, int mode, int pid) {
	 ...
	 */
	public FileOpenParams(
		String path, int openAction, int accessMode, int searchAttr,
		int fileAttr, int allocSize, long createDate, int pid) {
	 ...
	 */
	public FileOpenParams(
		String path, int openAction, int accessMode, int attr,
		int sharedAccess, long allocSize, int createOption, int rootFID,
		int secLevel, int secFlags, int pid) {
	...
	public final boolean isReadOnlyAccess() {
		...
		// return (m_accessMode & AccessMode.NTReadWrite) == AccessMode.NTRead ?
		// true : false;
	...
	public final boolean isWriteOnlyAccess() {
		...
		// return (m_accessMode & AccessMode.NTReadWrite) == AccessMode.NTWrite
		// ? true : false;
	...
	public final boolean isReadWriteAccess() {
		...
		// return (m_accessMode & AccessMode.NTReadWrite) ==
		// AccessMode.NTReadWrite ? true : false;
