...
public class NotifyChange {
	...
	private final static String[] _actnNames =
		{
			"Added", "Removed", "Modified", "RenamedOldName", "RenamedNewName",
	...
	/**
	 * Return the change notification filter flag as a string. This method
	 * assumes a single flag is set.
	 * 
	 * @param filter int
	 * @return String
	 */
