...
/**
 * SMB file attribute class. <p>Defines various bit masks that may be returned
 * in an FileInfo object, that is returned by the
 * DiskInterface.getFileInformation () and SearchContext.nextFileInfo() methods.
 * <p>The values are also used by the DiskInterface.StartSearch () method to
