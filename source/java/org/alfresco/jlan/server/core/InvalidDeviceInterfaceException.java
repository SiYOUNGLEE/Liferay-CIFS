...
/**
 * <p>This exception may be thrown by a SharedDevice when the device interface
 * has not been specified, the device interface does not match the shared device
 * type, or the device interface driver class cannot be loaded.
 * 
 * @author gkspencer
 */
