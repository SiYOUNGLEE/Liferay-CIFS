...
/**
 * <p>The device context is passed to the methods of a device interface. Each
 * shared device has a device interface and a device context associated with it.
 * The device context allows a single device interface to be used for multiple
 * shared devices.
 * 
 * @author gkspencer
 */
public class DeviceContext {
	...
	// Flag to indicate if the device is available. Unavailable devices will not
	// be listed by the various
	// protocol servers.
