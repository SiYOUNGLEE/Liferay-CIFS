...
/**
 * <p>The session listener interface provides a hook into the server so that an
 * application is notified when a new session is created and closed by a network
 * server.
 * 
 * @author gkspencer
 */
