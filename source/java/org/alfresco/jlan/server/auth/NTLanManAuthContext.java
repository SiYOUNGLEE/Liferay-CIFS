...
/**
 * NTLM1/LanMan CIFS Authentication Context Class <p>Holds the challenge sent to
 * the client during the negotiate phase that is used to verify the hashed
 * password in the session setup phase.
 * 
 * @author gkspencer
 */
