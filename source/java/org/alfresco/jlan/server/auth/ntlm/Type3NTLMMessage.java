...
public class Type3NTLMMessage extends NTLMMessage {
	...
	// Data block offset, used to indicate if session key and flags have been
	// specified
	...
	public final String getUserName() {
		return getStringValue(
			OffsetUserName, hasFlag(NTLM.FlagNegotiateUnicode));
	}
	...
	public final String getWorkstation() {
		return getStringValue(
			OffsetWorkstationName, hasFlag(NTLM.FlagNegotiateUnicode));
	}
	 ...
	 * @param flags int
	 */
	public final void buildType3(
		byte[] lmHash, byte[] ntlmHash, String domain, String username,
		String wksname, byte[] sessKey, int flags) {
		...
		dataOff =
			setStringValue(OffsetWorkstationName, wksname, dataOff, m_unicode);
