...
/**
 * NTLM Logon Details Class <p>Contains the details from the NTLM authentication
 * session that was used to authenticate a user.
 * 
 * @author gkspencer
 */
public class NTLMLogonDetails implements Serializable {
	...
	// Cached type 2 NTLM message and copy of the NTLM hash used to successfully
	// logon
	 ...
	 */
	public NTLMLogonDetails(
		String user, String wks, String domain, boolean guest, String authSrv) {
