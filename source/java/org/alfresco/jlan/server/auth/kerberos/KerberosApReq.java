				...
				if (derObj != null && derObj.isTagged()) {
						...
						if (derObj instanceof DERInteger) {
							...
							if (derInt.getValue() != 5)
								throw new IOException(
									"Unexpected PVNO value in AP-REQ");
						}
						break;
					...
					case 1:
						if (derObj instanceof DERInteger) {
							...
							if (derInt.getValue() != 14)
								throw new IOException(
									"Unexpected msg-type value in AP-REQ");
						}
						break;
					...
					case 3:
						if (derObj instanceof DERApplicationSpecific) {
							DERApplicationSpecific derApp =
								(DERApplicationSpecific) derObj;
					...
					case 4:
						if (derObj instanceof DERSequence) {
							...
							Iterator<DERObject> iterSeq =
								derAuthSeq.getObjects();
