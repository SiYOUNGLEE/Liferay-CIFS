...
/**
 * NegTokenInit Class <p> * Contains the details of an SPNEGO NegTokenInit blob
 * for use with CIFS.
 * 
 * @author gkspencer
 */
public class NegTokenInit {
	...
	public void decode(byte[] buf, int off, int len)
		...
		if (derObj instanceof DEROid) {
			...
			if (derObj instanceof DERSequence) {
				...
				/**
				 * derObj = derSeq.getTaggedObject( 3); if ( derObj != null) {
				 * // Check for the Microsoft format mechListMIC if ( derObj
				 * instanceof DERSequence) { } }
				 **/
			}
			else
	...
	public byte[] encode()
		...
		if (m_mecListMICPrincipal != null) {
			...
			DERGeneralString mecStr = new DERGeneralString(
				m_mecListMICPrincipal);
			mecStr.setTagNo(0);
