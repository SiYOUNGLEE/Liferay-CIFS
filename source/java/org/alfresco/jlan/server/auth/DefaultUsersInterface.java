...
/**
 * Default Users Interface <p>Use the user account list from the server
 * configuration to provide the user details.
 * 
 * @author gkspencer
 */
public class DefaultUsersInterface implements UsersInterface {
	...
	public void initializeUsers(
		...
		m_securityConfig = (SecurityConfigSection) config.getConfigSection(
