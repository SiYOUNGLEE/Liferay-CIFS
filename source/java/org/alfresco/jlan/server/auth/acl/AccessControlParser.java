...
/**
 * Access Control Parser Class <p>Creates an AccessControl instance by parsing a
 * set of name/value parameters.
 * 
 * @author gkspencer
 */
public abstract class AccessControlParser {
	...
	private final static String[] _accessTypes = {
		"None", "Read", "Write"
	};

	/**
	 * Return the access control type name that uniquely identifies this type of
	 * access control.
	 * 
	 * @return String
	 */
	...
	/**
	 * Create an AccessControl instance by parsing the set of name/value
	 * parameters
	 * 
