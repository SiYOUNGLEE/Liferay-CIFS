...
/**
 * Access Control Base Class <p>Controls access to a shared filesystem.
 * 
 * @author gkspencer
 */
public abstract class AccessControl {
	...
	private final static String[] _accessType = {
		"None", "Read", "Write"
	};
	 ...
	 * @return int
	 */
	public abstract int allowsAccess(
		SrvSession sess, SharedDevice share, AccessControlManager mgr);

	/**
	 * Return the index of a value from a list of valid values, or 01 if not
	 * valid
	 * 
	 * @param val String
	 * @param valid String[]
	 ...
	 * @return int
	 */
	protected final static int indexFromList(
		String val, String[] valid, boolean caseSensitive) {
