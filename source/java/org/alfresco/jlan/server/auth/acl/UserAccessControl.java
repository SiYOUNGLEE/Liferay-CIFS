...
/**
 * User Access Control Class <p>Allow/disallow access to a shared device by
...
public class UserAccessControl extends AccessControl {
	...
	/**
	 * Check if the user name matches the access control user name and return
	 * the allowed access.
	 * 
	...
	public int allowsAccess(
		...
		if (cInfo.getUserName() != null &&
			cInfo.getUserName().equalsIgnoreCase(getName()))
			return getAccess();
		return Default;
	}
