...
/**
 * Server Configuration Class <p>Provides the configuration parameters for the
 * network file servers (SMB/CIFS, FTP and NFS).
 * 
 * @author gkspencer
 */
public class ServerConfiguration implements ServerConfigurationAccessor {
	 ...
	 * 
	 * @see
	 * org.alfresco.jlan.server.config.ServerConfigurationAccessor#getConfigSection
	 * (java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * org.alfresco.jlan.server.config.ServerConfigurationAccessor#getServerName
	 * ()
	 */
