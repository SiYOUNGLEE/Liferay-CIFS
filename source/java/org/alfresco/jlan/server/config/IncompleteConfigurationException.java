...
/**
 * <p>Indicates that the server configuration is incomplete, and the server
 * cannot be started. <p>The server name, domain name and network broadcast mask
 * are the minimum parameters that must be specified for a server configuration.
 * 
 * @author gkspencer
 */
