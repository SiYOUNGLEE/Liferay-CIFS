...
public class DriveMappingsConfigSection extends ConfigSection {
	...
	// Win32 local drive mappings to be added when the SMB/CIFS server has
	// started
	...
	/**
	 * Determine if there are mapped drives specified to be added when the
	 * SMB/CIFS server has started
	 * 
	 * @return boolean
	 */
	...
	public final int setMappedDrives(DriveMappingList mappedDrives)
		...
		int sts =
			fireConfigurationChange(ConfigId.SMBMappedDrives, mappedDrives);
