 ...
 * useful for testing how well an application responds to JVM crashes. It has
 * been broken out frtom the WrapperManagerMBean interface so system
...
public interface WrapperManagerTestingMBean {
	 ...
	 * to be hung when viewed from the native Wrapper code. Does not have any
	 * effect when the JVM is not being controlled from the native Wrapper.
	 */
	void appearHung();
