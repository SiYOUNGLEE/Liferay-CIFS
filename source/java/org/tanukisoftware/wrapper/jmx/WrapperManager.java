...
public class WrapperManager implements WrapperManagerMBean {
	...
	public boolean isProfessionalEdition() {
		return org.tanukisoftware.wrapper.WrapperManager
	 ...
	 * The restart is actually performed in a background thread allowing JMX a
	 * chance to respond to the client.
	 */
	public void restart() {
	 ...
	 * <p> The stop is actually performed in a background thread allowing JMX a
	 * chance to respond to the client.
	 * 
