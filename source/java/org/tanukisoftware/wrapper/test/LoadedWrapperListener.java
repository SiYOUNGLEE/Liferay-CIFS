...
public class LoadedWrapperListener implements WrapperListener, Runnable {
	...
	public Integer start(String[] args) {
		...
		synchronized (this) {
			...
			// Wait for five seconds to give the application a chance to have
			// failed.
			...
			if (WrapperManager.isDebugEnabled()) {
				System.out.println(
					"LoadedWrapperListener: start(args) end.  Main Completed=" +
	...
	public void controlEvent(int event) {
		if (WrapperManager.isControlledByNativeWrapper()) {
			if (WrapperManager.isDebugEnabled()) {
				System.out.println("LoadedWrapperListener: controlEvent(" +
					event + ") Ignored");
			}
	...
	public void run() {
		...
		try {
			if (WrapperManager.isDebugEnabled()) {
				System.out.println(
					"LoadedWrapperListener: invoking start main method");
			}
			appMain(m_startMainArgs);
			if (WrapperManager.isDebugEnabled()) {
				System.out.println(
					"LoadedWrapperListener: start main method completed");
			}
